...
exports.OpenAIResponsesAPI = void 0;
const axios_1 = __importDefault(require("axios"));
const core_1 = require("@flyde/core");
exports.OpenAIResponsesAPI = {
    ...
    inputs: {
        ...
        modelOptions: {
            group: (0, core_1.createInputGroup)("Model Options", ["temperature", "maxOutputTokens", "topP"], {
                collapsible: true,
                defaultCollapsed: true,
            }),
        },
        ...
        toolsAndAdvanced: {
            group: (0, core_1.createInputGroup)("Tools & Advanced", ["tools", "toolChoice", "reasoningEffort"], {
                collapsible: true,
                defaultCollapsed: true,
            }),
        },
    ...
    run: async (inputs, outputs, adv) => {
        var _a;
        const { apiKey, stateMode, model, input, previousResponseId, conversationHistory, temperature, maxOutputTokens, topP, tools, toolChoice, reasoningEffort } = inputs;
        if (!apiKey) {
        ...
        try {
            const res = await axios_1.default.post("https://api.openai.com/v1/responses", data, { headers });
            ...
            if (axios_1.default.isAxiosError(error) && error.response) {
                ...
                adv.onError(`OpenAI Responses API Error ${error.response.status}: ${((_a = errorData.error) === null || _a === void 0 ? void 0 : _a.message) || error.response.statusText}`);
                return;
            }
