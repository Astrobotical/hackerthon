...
`,
    ...
    inputs: {
        authentication: {
            group: (0, core_1.createInputGroup)("Authentication", ["apiKey", "baseId"], {
                collapsible: true,
        ...
        additionalOptions: {
            group: (0, core_1.createInputGroup)("Additional Options", ["maxRecords", "filterFormula"], {
                collapsible: true,
                defaultCollapsed: true,
            }),
            condition: "action === 'listRecords'",
    ...
    run: async (inputs, outputs, adv) => {
        var _a;
        const { apiKey, baseId, action, tableName, recordId, fields, maxRecords, filterFormula, } = inputs;
        if (!apiKey) {
        ...
        try {
            ...
            if (axios_1.default.isAxiosError(error) && error.response) {
                ...
                adv.onError(`Airtable API Error ${error.response.status}: ${((_a = errorData.error) === null || _a === void 0 ? void 0 : _a.message) || error.response.statusText}`);
                return;
            }
