...
`,
    ...
    inputs: {
        ...
        searchOptions: {
            group: (0, core_1.createInputGroup)("Search Options", ["query"], {
                collapsible: true,
        ...
        pageOptions: {
            group: (0, core_1.createInputGroup)("Page Options", ["properties", "content"], {
                collapsible: true,
                defaultCollapsed: true,
            }),
            condition: "action === 'createPage' || action === 'updatePage'",
    ...
    run: async (inputs, outputs, adv) => {
        var _a;
        const { apiKey, action, databaseId, pageId, filter, sorts, properties, content, query, } = inputs;
        if (!apiKey) {
        ...
        try {
            ...
            if (axios_1.default.isAxiosError(error) && error.response) {
                ...
                adv.onError(`Notion API Error ${error.response.status}: ${((_a = errorData === null || errorData === void 0 ? void 0 : errorData.error) === null || _a === void 0 ? void 0 : _a.message) || error.response.statusText}`);
                return;
            }
