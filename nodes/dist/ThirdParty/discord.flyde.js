...
exports.DiscordMessage = {
    id: "DiscordMessage",
    menuDisplayName: "Discord",
...
<svg width="24px" height="24px" viewBox="0 -28.5 256 256" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" preserveAspectRatio="xMidYMid">
    ...
    inputs: {
        ...
        username: {
            ...
            editorType: "string",
            description: "Username for the message",
        },
        content: {
            defaultValue: "Hello from https://www.getflowcode.io",
            editorType: "string",
        ...
        avatarUrl: {
            defaultValue: "",
            editorType: "string",
            description: "Avatar URL for the message",
        },
    },
    outputs: {
        result: {
