import { createInputGroup, } from "@flyde/core";
...
`,
    ...
    inputs: {
        ...
        fileOptions: {
            group: createInputGroup("File Options", ["fileContent", "fileName", "fileType"], {
                collapsible: true,
                defaultCollapsed: true,
            }),
        ...
        historyOptions: {
            group: createInputGroup("History Options", ["limit", "oldest", "latest"], {
                collapsible: true,
                defaultCollapsed: true,
            }),
