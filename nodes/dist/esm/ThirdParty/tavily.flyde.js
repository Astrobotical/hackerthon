...
`,
    ...
    inputs: {
        ...
        searchOptions: {
            group: createInputGroup("Search Options", ["searchDepth", "maxResults", "includeDomains", "excludeDomains"], {
                collapsible: true,
                defaultCollapsed: true,
            }),
        },
    ...
    run: async (inputs, outputs, adv) => {
        var _a;
        const { apiKey, action, query, searchDepth, maxResults, includeDomains, excludeDomains, } = inputs;
        if (!apiKey) {
        ...
        try {
            ...
            if (axios.isAxiosError(error) && error.response) {
                ...
                adv.onError(`Tavily API Error ${error.response.status}: ${((_a = errorData.error) === null || _a === void 0 ? void 0 : _a.message) || error.response.statusText}`);
                return;
            }
