...
import { extractInputsFromValue, replaceInputsInValue, } from "@flyde/core";
var ConditionType;
...
export const Conditional = {
    ...
    run: (inputs, outputs, adv) => {
        ...
        const leftSide = replaceInputsInValue(inputs, leftOperand, "leftOperand", false);
        const rightSide = replaceInputsInValue(inputs, rightOperand, "rightOperand", false);
