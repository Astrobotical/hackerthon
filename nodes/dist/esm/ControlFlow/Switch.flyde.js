export const Switch = {
    ...
    menuDescription: "Allows you to switch between multiple outputs based on the value of one input or more, using code expressions",
    displayName: () => "Switch",
    description: (config) => `Switch between ${config.cases.length} cases based on conditions`,
    defaultConfig: {
        inputs: ["value"],
        cases: [
            {
    ...
    inputs: (config) => config.inputs.reduce((acc, name, i) => {
