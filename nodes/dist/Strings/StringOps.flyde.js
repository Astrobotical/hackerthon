...
exports.StringOps = {
    ...
    inputs: {
        ...
        singleStringInputs: {
            group: (0, core_1.createInputGroup)("String Input", ["string"], {
                collapsible: true,
                defaultCollapsed: false,
            }),
            condition: "['toLowerCase', 'toUpperCase', 'trim', 'toCamelCase', 'toKebabCase', 'toPascalCase', 'toSnakeCase', 'toTitleCase', 'length', 'isEmpty'].includes(operation)",
        },
        string: {
        ...
        twoStringInputs: {
            group: (0, core_1.createInputGroup)("Two String Inputs", ["string", "searchString"], {
                collapsible: true,
                defaultCollapsed: false,
            }),
            condition: "['includes', 'startsWith', 'endsWith', 'indexOf', 'lastIndexOf'].includes(operation)",
        },
        searchString: {
            description: "Search string for operations like includes, indexOf, startsWith, etc.",
        },
        // Substring operation
        substringInputs: {
            group: (0, core_1.createInputGroup)("Substring Inputs", ["string", "start", "end"], {
                collapsible: true,
                defaultCollapsed: false,
            }),
        ...
        // Replace operation
        replaceInputs: {
            group: (0, core_1.createInputGroup)("Replace Inputs", ["string", "searchValue", "replaceValue"], {
                collapsible: true,
                defaultCollapsed: false,
            }),
        ...
        // Join operation
        joinInputs: {
            group: (0, core_1.createInputGroup)("Join Inputs", ["array", "separator"], {
                collapsible: true,
                defaultCollapsed: false,
            }),
        ...
        // Split operation
        splitInputs: {
            group: (0, core_1.createInputGroup)("Split Inputs", ["string", "separator"], {
                collapsible: true,
                defaultCollapsed: false,
            }),
        ...
        // Concat operation
        concatInputs: {
            group: (0, core_1.createInputGroup)("Concat Inputs", ["string", "strings"], {
                collapsible: true,
                defaultCollapsed: false,
            }),
        ...
        // CharAt operation
        charAtInputs: {
            group: (0, core_1.createInputGroup)("CharAt Inputs", ["string", "index"], {
                collapsible: true,
                defaultCollapsed: false,
            }),
        ...
        matchRegexInputs: {
            group: (0, core_1.createInputGroup)("MatchRegex Inputs", ["string", "regex"], {
                collapsible: true,
                defaultCollapsed: false,
            }),
    ...
    run: (inputs, outputs, adv) => {
        const { operation, string, searchString, start, end, searchValue, replaceValue, array, separator, strings, index, regex, } = inputs;
        try {
            let result;
            switch (operation) {
                // String transformations
                ...
                case "emptyString":
                    ...
                    break;
                case "concat":
                    result = string.concat(...(Array.isArray(strings) ? strings : [strings]));
                    break;
                // String queries
                case "length":
            ...
            adv.onError(`String operation error: ${error.message}`);
        }
    },
    aliases: [
        "toLowerCase",
